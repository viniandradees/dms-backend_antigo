...
{
    public class DiseaseSupplementDosageAgeRangeDto
    {
        public int Id { get; set; }
        public int DiseaseSupplementDosageId { get; set; }
        ...
        public DiseaseSupplementDosage DiseaseSupplementDosage { get; set; }
    }
}
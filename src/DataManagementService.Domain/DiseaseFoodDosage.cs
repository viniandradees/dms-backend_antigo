...
namespace DataManagementService.Domain
{
    ...
    public class DiseaseFoodDosage
    {
        [Key]
        [Column("id", Order = 1)]
        [JsonPropertyOrder(1)]
        ...
        [Column("disease_food_id", Order = 2)]
        [JsonPropertyOrder(2)]
        ...
        [JsonPropertyOrder(6)]
        public IEnumerable<DiseaseFoodDosageAgeRange> AgeRanges { get; set; }

        [JsonPropertyOrder(7)]
        public MeasurementUnit MeasurementUnit { get; set; }

        [JsonPropertyOrder(8)]
        public DiseaseFood DiseaseFood { get; set; }
    }
}

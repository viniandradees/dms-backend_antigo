...
namespace DataManagementService.Domain
{
    ...
    public class DiseaseDrugDosage
    {
        [Key]
        [Column("id", Order = 1)]
        [JsonPropertyOrder(1)]
        ...
        [Column("disease_drug_id", Order = 2)]
        [JsonPropertyOrder(2)]
        ...
        [JsonPropertyOrder(6)]
        public IEnumerable<DiseaseDrugDosageAgeRange> AgeRanges { get; set; }

        [JsonPropertyOrder(7)]
        public MeasurementUnit MeasurementUnit { get; set; }

        [JsonPropertyOrder(8)]
        public DiseaseDrug DiseaseDrug { get; set; }
    }
}
